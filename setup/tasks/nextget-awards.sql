...
VALUES (
    'Nextgen Awards',                        -- Replace text between quotes with task name
    'Awards will be given to the best projects of the OS''s first term!',                 -- Replace text between quotes with task description. Use <br> for line break and use it twice to start a new paragraph
    ...
    TIMESTAMP '2018-10-09 09:00:00',    -- Replace between quotes with actual date and time (YYYY-MM-DD hh:mm:ss).
