...
VALUES (
    'Blocker Interpersonal Skills Workshop',                        -- Replace text between quotes with task name
    'Continue developing your interpersonal skills with these workshops by Kathleen and Barb!',                 -- Replace text between quotes with task description. Use <br> for line break and use it twice to start a new paragraph
    ...
    TIMESTAMP '2018-10-11 09:00:00',    -- Replace between quotes with actual date and time (YYYY-MM-DD hh:mm:ss).
