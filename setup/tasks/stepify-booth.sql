...
VALUES (
    'Visit Stepify Booth',                        -- Replace text between quotes with task name
    'You''ll see some cool statistics about our onboarding days! Check out the working web app! We will also discuss the different use cases for the future of Stepify. We will be showing our video as well.',                 -- Replace text between quotes with task description. Use <br> for line break and use it twice to start a new paragraph
