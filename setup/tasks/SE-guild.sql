...
VALUES (
    'Attend 1st SE Guild',                        -- Replace text between quotes with task name
    'Attend your first SE guild and see what Software Engineering is all about!',                 -- Replace text between quotes with task description. Use <br> for line break and use it twice to start a new paragraph
    ...
    TIMESTAMP '2018-10-10 13:00:00',    -- Replace between quotes with actual date and time (YYYY-MM-DD hh:mm:ss).
    ...
    FALSE,  -- TRUE if applicable to students enrolled in PM, else FALSE
