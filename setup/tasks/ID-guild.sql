...
VALUES (
    'Attend 1st ID Guild',                        -- Replace text between quotes with task name
    'Attend your first ID guild and see what Interaction Design is all about!',                 -- Replace text between quotes with task description. Use <br> for line break and use it twice to start a new paragraph
