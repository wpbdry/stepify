...
VALUES (
    'Attend OS Projects Fair',                        -- Replace text between quotes with task name
    'Check out what your fellow students have been up to for the last month!',                 -- Replace text between quotes with task description. Use <br> for line break and use it twice to start a new paragraph
    ...
    TIMESTAMP '2018-10-08 09:00:00',    -- Replace between quotes with actual date and time (YYYY-MM-DD hh:mm:ss).
