...
VALUES (
    'Vote for Stepify!',                        -- Replace text between quotes with task name
    'You have a chance to vote for the Stepify app in four different categories! Best booth design, best technology, best results and best attempt. Simply visit the ''Vote!'' link above, sign in with your CODE email address, and vote.',                 -- Replace text between quotes with task description. Use <br> for line break and use it twice to start a new paragraph
    ...
    TIMESTAMP '2018-10-08 16:00:00',    -- Replace between quotes with actual date and time (YYYY-MM-DD hh:mm:ss).
                                        -- Delete entire line above and type NULL (without quotes) if it's 0 or 1 above
    'Vote!',                 -- or name of website, if "location" is online
    'https://brittakiwit.typeform.com/to/tgzxoE',                  -- Either google maps url, or url to website. Please include "https://" in URL
