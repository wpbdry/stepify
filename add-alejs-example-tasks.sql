...
VALUES (
    ...
    'This student ID will give you access to all the public transportation in Berlin (Potsdam included). Of course it will also give you access to all student discounts'||E'\n\n'||'Once you have paid for it, please pick it up with Ina.'||E'\n\n'||'Prices semester ticket:'||E'\n'||'6 months is 193.80 Euro.'||E'\n'||'for enrollment on August 1: 161.50 Euro'||E'\n'||'for enrollment on September 1: 129.20 Euro'||E'\n\n'||'Bank transfer:'||E'\n'||'CODE Education GmbH, IBAN DE43 1005 0000 0190 5692 63, BIC BELADEBEXXX'||E'\n\n'||'PayPal transfer:'||E'\n'||'billing@code.berlin (please identify the payment as “friends or family” to avoid fees)',                 -- Replace text between quotes with task description
